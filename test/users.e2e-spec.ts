...
describe("Users E2E test", () => {
  ...
  // it('/users (GET) --> 401 "UnauthorizedException" error ', () => {
  //   return request(app.getHttpServer())
  //     .get("/users")
  //     .set("Authorization", `Bearer ${token}`)
  //     .expect("Content-Type", /json/)
  ...
  // it('/users (GET) --> 404 "NotFoundException" error ', () => {
  //   return request(app.getHttpServer())
  //     .get("/users")
  //     .set("Authorization", `Bearer ${token}`)
  //     .expect("Content-Type", /json/)
  ...
  // it("/auth/sign-in-admin (POST) --> 200", () => {
  //   return request(app.getHttpServer())
  ...
  // it("/auth/sign-in-admin (POST) --> 401", () => {
  //   return request(app.getHttpServer())
  //     .post("/auth/sign-in-admin")
  //     .send({
  //       email: "muhammadsodiqmuhammadjao0v@gmail.com",
